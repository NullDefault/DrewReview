    ...
    >
      ...
      >
        ...
        >
          ...
          <List spacing={3}>
            <ListItem>
              <ListIcon as={BsFileRichtext} color="pink.400" />A writing sample
              incorporating at least 2 scholarly sources and minimum 5 pages in
              length,
            </ListItem>
            <ListItem>
              <ListIcon as={GiLetterBomb} color="pink.400" />A cover letter
              explaining why you would like to serve on the editorial board of
              The Drew Review,
            </ListItem>
            <ListItem>
